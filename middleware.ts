...
export const config = {
  matcher: ["/admin/:path*", "/attendance/:path*", "/grades/:path*", "/parent/:path*", "/report/:path*", "/student/:path*", "/government/:path*", "/receipt/:path*", "/library/:path*", "/curate/:path*", "/wellbeing/:path*", "/handover/:path*", "/ussd-demo/:path*"],
};
