...
// Handover board is reached by both admins and teachers — role resolved by the
// shell so the persistent nav is always correct.
export default async function HandoverLayout({ children }: { children: React.ReactNode }) {
