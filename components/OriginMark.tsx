...
// currentColor so it adapts to light/dark; the dot is always brand cyan. Set
// `rings` for the concentric hero variant.
export function OriginMark({
  ...
  return (
    ...
    >
      ...
      <circle cx="12" cy="12" r="3.4" fill="var(--et-cyan)" />
    </svg>
  );
}
